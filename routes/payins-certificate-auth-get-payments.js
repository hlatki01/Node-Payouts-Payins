...
function generateHmacSha256Signature(payload, secretKey) {
  // Create an HMAC SHA256 hash using the provided payload and secret key
...
router.post('/', async (req, res) => {
  // API endpoint URL
  const apiURL = 'https://sandbox-cert.dlocal.com/payments-methods?country';
  ...
  try {
    // Make a GET request to the API with authentication headers and payload
